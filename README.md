<h2>I'm Christopher/Krzysztof Bojarczuk - Junior .NET and Angular developer. I'm interested in development and budling web application. Looking for an job - remote.</h2>
...
My small projects with Asp.net core and Angular:
 ...
 [Enterprise Management System](https://github.com/KrzysztofBojarczuk/EMS)  Clean Architecture + CQRS + Asp.net Webapi + ASP.NET Identity + JWT Token + React + Prime React + Prime Flex (after login user has acces to his resources - beginner React)
